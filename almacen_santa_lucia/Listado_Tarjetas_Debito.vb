Public Class Listado_Tarjetas_Debito

    Private Sub Listado_Tarjetas_Debito_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub

    Private Sub Listado_Tarjetas_Debito_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Listado_Tarjetas_Debito_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Busqueda_Tarjetas()
        ...
        End If
        Dim Tarjetas As New Tarjetas_Debito
        dgvTarjetas.DataSource = Tarjetas.Listado_Tarjetas_Debito(Condicion)
    ...
    Private Sub btnAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click
        ...
        fun.Seleccionar_Dato_Grilla(dgvTarjetas, Pasa_ID_Tarjeta_Debito, 0)
    End Sub

    Private Sub btnModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModificar.Click
        If dgvTarjetas.RowCount > 0 Then
            Pasa_ID_Tarjeta_Debito = dgvTarjetas.CurrentRow.Cells(0).Value
            Accion_Usuario = "M"
            ABM_Tarjetas_Debito.ShowDialog()
            Busqueda_Tarjetas()
            Dim fun As New Funciones
    ...
    Private Sub Listado_Tarjetas_Debito_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
